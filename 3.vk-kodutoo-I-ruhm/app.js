...
$(document).ready(function(){
  $("#add-new-notebook").click(function(){
    var datepicker = $("#datepicker").val();
    var reminder_content = $("#reminder_content").val();

  // Returns successful data submission message when the entered information is stored in database.
  var new_notebook1 = 'datepicker='+ datepicker + '&reminder_content='+ reminder_content;
  if(datepicker===''||reminder_content===''){
